...
Если отчёт пустой — скопируй `standards/templates/report-skeleton.md`, заполни §1–§3 (**koi-report-review**, критики 1–3), затем продолжай выполнение.
...
Галочка = критерий из той же строки SMART-подзадачи (см. `standards/no-ai-report-rules.md` § Подзадачи). Критик 3 в **koi-report-review** проверяет соответствие.
