...
`standards/templates/report-skeleton.md` и `standards/no-ai-report-rules.md`.
Рабочий слой — `*.run.md` по `agent/templates/experiment-report.md`.
...
- Шаблон: `standards/templates/report-skeleton.md`
- Правила: `standards/no-ai-report-rules.md`
- Рабочий отчёт: `agent/templates/experiment-report.md`
- Карточки/UI (не отчёт): `koi-prose-style`
- Ingest: `agent/AGENTS.md` (форматные ворота §0, §5.1, §5.2 json)
